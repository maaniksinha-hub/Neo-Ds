...
- `TypographyDoc` — full Display/Highlight/Heading/Title/Body/Caption type scale transcribed from Figma's Typography page (Foundations/Typography in Storybook)

...
import { WSideNav } from './wSideNav';

const meta = {
  title: 'Components/wSideNav',
  component: WSideNav,
  tags: ['autodocs'],
} satisfies Meta<typeof WSideNav>;
...
export const Expanded: Story = {
  ...
  render: () => {
    ...
    return <WSideNav items={items} activeKey={active} onChange={setActive} />;
  },
};
...
export const Collapsed: Story = {
  ...
  render: () => {
    const [active, setActive] = useState('home');
    return <WSideNav items={items} activeKey={active} onChange={setActive} collapsed />;
  },
};
